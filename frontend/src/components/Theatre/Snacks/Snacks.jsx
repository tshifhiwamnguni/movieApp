...
function Snacks() {
  ...
  const deleteSnack = async () => {
    setLoading(true);
    await axios
      .delete(`${API}/theatre-snacks/${snackID.current}`, {
        headers: {
          Authorization: `Bearer ${TOKEN}`,
        },
      })
  ...
  const uploadSnackImage = async (e) => {
    ...
    formData.append("ref", "api::theatre-snack.theatre-snack");
    ...
    await axios
      ...
      .then((data) => {
        ...
        axios
          .put(
            `${API}/theatre-snacks/${snackID.current}?populate=*`,
  ...
  const addSnack = async () => {
    ...
    await axios
      .post(`${API}/theatre-snacks?populate=*`, snackData, {
        headers: {
          Authorization: `Bearer ${TOKEN}`,
        },
      })
    ...
    formData.append("files", snackImageUrl.current);
    formData.append("refID", snackID.current);
    formData.append("field", "snackImage");
    formData.append("ref", "api::theatre-snack.theatre-snack");
    await axios
      .post(`${API}/upload`, formData, {
        headers: {
  ...
  const updateSnack = () => {
    ...
    axios
      .put(`${API}/theatre-snacks/${snackID.current}?populate=*`, snackData, {
        headers: {
          Authorization: `Bearer ${TOKEN}`,
        },
      })
