...
function CinemaProfile() {
  ...
  // update a cinema profile image
  const uploadCinemaPoster = async (e) => {
    e.preventDefault();
    setLoading(true);

    const formData = new FormData();
    formData.append("files", cinemaProfile.current);
    formData.append("refID", cinemaProfile.current);
    formData.append("field", "cinemaImage");
    formData.append("ref", "api::cinema.cinema");
    ...
    await axios
      ...
      .then((data) => {
        ...
        axios
          .put(
            `${API}/cinemas/${cinemaID.current}?populate=*`,
            { data: { cinemaImage: imgUrl.current } },
            {
              headers: {
                Authorization: `Bearer ${TOKEN}`,
              },
  ...
  const getUser = async () => {
    ...
    axios
      ...
      .then((data) => {
        ...
        setImage(data.data.cinema.cinemaImage);
